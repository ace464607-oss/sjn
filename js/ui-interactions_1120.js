...
function injectCustomStyles() {
    ...
    style.textContent = `
        ...
        #view-compare-btn i { color: #64748b; font-size: 16px; }
        #compare-count-badge {
            background: #007bff; color: white; border-radius: 999px;
...
export function initializeUI(telecomData) {
    ...
    document.body.addEventListener('click', (e) => {
        // AI 플래너 상세 모달의 닫기 버튼 ID 또는 클래스 체크
    ...
    function setupPageViewToggle() {
        ...
        if (heroAiPlannerBtn) heroAiPlannerBtn.addEventListener('click', (e) => { e.preventDefault(); showAiView(); });
